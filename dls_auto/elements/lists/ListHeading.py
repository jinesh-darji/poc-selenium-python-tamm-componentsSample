...
class ListHeading(BaseElement):
    def __init__(self, locator_reader, element_key, lbl_title, lbl_description, btn_complete, chckbx_complete, btn_arrow):
        super(ListHeading, self).__init__(locator_reader, element_key)
        self.lbl_title = Label(locator_reader, lbl_title)
        self.lbl_description = Label(locator_reader, lbl_description)
    ...
    def is_description_in_list(self):
        return self.lbl_description.is_present()
